...
#$ -m ae
#$ -cwd
#$ -o ~/../../../group/capra/projects/archaic_splicing/scripts/analysis/concat_introgressed_variants.out
#$ -e ~/../../../group/capra/projects/archaic_splicing/scripts/analysis/concat_introgressed_variants.err
#$ -l h_rt=1:00:00
#$ -l mem_free=5G
