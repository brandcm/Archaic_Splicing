This directory contains scripts to apply SpliceAI to archaic variants and concatenate the results. Scripts are listed in the order in which they should be launched.
