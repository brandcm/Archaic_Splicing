...
#$ -m ae
#$ -cwd
#$ -o ~/../../../group/capra/projects/archaic_splicing/scripts/4_modern_data_preparation/calculate_non_ASW_AFR_allele_frequencies.out
#$ -e ~/../../../group/capra/projects/archaic_splicing/scripts/4_modern_data_preparation/calculate_non_ASW_AFR_allele_frequencies.err
#$ -l h_rt=6:00:00
#$ -l mem_free=20G
