...
#$ -m ae
#$ -cwd
#$ -o ~/../../../group/capra/projects/archaic_splicing/scripts/4_modern_data_preparation/query_1KG_allele_frequencies.out
#$ -e ~/../../../group/capra/projects/archaic_splicing/scripts/4_modern_data_preparation/query_1KG_allele_frequencies.err
#$ -l h_rt=12:00:00
#$ -l mem_free=30G
