...
# designate path to 1000 genomes data, hg38 fasta, and change directories
thousand_genomes="../../../../data/wynton_databases/1000_genomes/release/20190312_biallelic_SNV_and_INDEL/"
hg38="../../../../data/hg38_fasta/2022-03-14/hg38.fa"
...
for c in ${chrs[@]}; do bcftools norm -m - -f "$hg38" "$thousand_genomes"ALL."$c".shapeit2_integrated_snvindels_v2a_27022019.GRCh38.phased.vcf.gz -O z -o normalized_"$c"_1000_genomes.vcf.gz & done
wait
